...
class HttpRequest:
    def __init__(self, request=''):
        ...
        if request:
            ...
            if 'user_agent' in header: self.user_agent = header['user_agent']
            if 'accept_lang' in header: self.accept_lang = header['accept-lang']
            if 'accept-encoding' in header: self.accept_encoding = header['accept-encoding']
